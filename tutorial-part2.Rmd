...
Note: If the end of a function is reached without calling return, the value of the last evaluated expression is returned. It's good practice to explicitly return a value.
